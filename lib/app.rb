...
selected_journalist = journalists[rand(journalists.size)]
...
#client.update("#{selected_journalist}, votre dernier article était une pure merveille. #bonjour_monde")
...
# 2.4
 clientStream.filter(track: "#Bonjour_monde") do |tweet|
  puts tweet.text
